...
$extensions = array(
    '1' => (object) array(
        ...
        'url'       => 'https://shopitpress.com/themes/woocommerce/wpgumby/?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v1.0.0&utm_campaign=wooinfluencer',
        'title'     => __( 'WPGumby', 'shopitpress' ),
        'desc'      => __( 'Flat and responsive WooCommerce theme.<br>', 'shopitpress' ),
    ),
	);
